...
#ifndef GENIE_MSGS__MSG__DETAIL__HEAD_STATE__TRAITS_HPP_
#define GENIE_MSGS__MSG__DETAIL__HEAD_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const genie_msgs::msg::HeadState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const genie_msgs::msg::HeadState & msg)
{
  return genie_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<genie_msgs::msg::HeadState>()
{
  return "genie_msgs::msg::HeadState";
}

template<>
inline const char * name<genie_msgs::msg::HeadState>()
{
  return "genie_msgs/msg/HeadState";
}

template<>
struct has_fixed_size<genie_msgs::msg::HeadState>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<genie_msgs::msg::HeadState>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<genie_msgs::msg::HeadState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GENIE_MSGS__MSG__DETAIL__HEAD_STATE__TRAITS_HPP_
