...
export const ui = {
  en: {
    ...
    hero: {
      eyebrow: 'OPEN-SOURCE EMBODIED AI INFRASTRUCTURE',
      titleHighlight: 'VLA Models to Real Robots',
    ...
    case: {
      ...
      title: 'Flagship Case: Robot Tea House — Fully Autonomous 17-Step Chinese Tea Ceremony',
      background:
        'Showcased at the Digital China Summit — the industry’s first fully autonomous 17-step long-horizon task (tea pouring, brewing, decanting, serving).',
      stackLabel: 'Hardware & Software Stack',
      stack: 'AgileX Spirit G1 robot + Lingxi Shutao VLA base + Open-RAIL foundation',
      metrics: [
        { value: '17 steps', label: 'Full-process autonomous loop' },
        { value: '80%', label: 'One-shot full-process success' },
        { value: '<5%', label: 'Scooping spill rate' },
        { value: '7', label: 'Transferable atomic skills' },
      ],
      scenesLabel: 'Applicable scenarios: ',
      scenes: 'High-end tea houses · hotel receptions · exhibition experience halls · cultural senior-care centers',
      placeholderTitle: 'Robot tea-brewing photo',
      placeholderNote: 'Case image to be replaced · showcased at Digital China Summit',
    },
    eco: {
