...
class DiffusionConfig:
    ...
    #         "observation.image": [3, 680, 480],
    #         "observation.state": [9],
    #     }
    # )
    input_shapes: Dict[str, List[int]] = field(
        default_factory=lambda: {
            "observation.image.head": [3, 680, 480],
            "observation.image.right": [3, 680, 480],
            "observation.state": [9],
        }
    )
    ...
    crop_shape: Optional[Tuple[int, int]] = (480, 480)
    ...
    # Unet.
    down_dims: Optional[Tuple[int, ...]] = (512, 1024, 2048)
    kernel_size: int = 5
    n_groups: int = 8
