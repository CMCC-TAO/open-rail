...
def get_robotB_config():
    ...
    config.thre_progress_finish = {
        "default": 0.84,
        "pick_custardbun": 0.84,
        "pick_shrimpdumpling": 0.84,
        "place_custardbun": 0.84,
        "place_shrimpdumpling": 0.84,
    }
    config.language = {
        "default": "",
...
def get_robotC_config():
    ...
    config.reset_pose = {
        "default": [-1.0748, 0.6107, 0.2816, -1.2823, 0.7292, 1.4957, -0.1869, 1.0720, -0.6103, -0.2780, 1.2822, -0.7299, -1.4929, 0.1873] + [0, 0] + [0.0, 0.4363] + [0.2967, 22.0] + [0.0, 0.0],
        "pour_water_greentea": [-1.0748, 0.6107, 0.2816, -1.2823, 0.7292, 1.4957, -0.1869, 1.0720, -0.6103, -0.2780, 1.2822, -0.7299, -1.4929, 0.1873] + [0, 0] + [0.0, 0.4363] + [0.2967, 22.0] + [0.0, 0.0],
        "pour_water_blacktea": [-1.0748, 0.6107, 0.2816, -1.2823, 0.7292, 1.4957, -0.1869, 1.0720, -0.6103, -0.2780, 1.2822, -0.7299, -1.4929, 0.1873] + [0, 0] + [0.0, 0.4363] + [0.2967, 22.0] + [0.0, 0.0],
        "place_greentea": [-1.0748, 0.6107, 0.2816, -1.2823, 0.7292, 1.4957, -0.1869, 1.0720, -0.6103, -0.2780, 1.2822, -0.7299, -1.4929, 0.1873] + [0, 0] + [0.0, 0.4363] + [0.2967, 22.0] + [0.0, 0.0],
        "place_blacktea": [-1.0748, 0.6107, 0.2816, -1.2823, 0.7292, 1.4957, -0.1869, 1.0720, -0.6103, -0.2780, 1.2822, -0.7299, -1.4929, 0.1873] + [0, 0] + [0.0, 0.4363] + [0.2967, 22.0] + [0.0, 0.0],
    }
    config.thre_progress_finish = {
        "default": 0.84,
        "pour_water_greentea": 0.84,
        "pour_water_blacktea": 0.84,
        "place_greentea": 0.84,
        "place_blacktea": 0.84,
    }
    config.language = {
