...
def get_robotD_config():
    ...
    config.reset_pose_finish = {
        ...
        "pick_orange": [-1.0738, 0.6108, 0.2796, -1.2836, 0.7301, 1.4947, -0.1875, 1.0743, -0.611 , -0.2796, 1.2839, -0.7304, -1.4953, 0.1876] + [1.0, 0.0] + [0.9599, 0.4363] + [0.0, 27.0] + [0.0, 0.0],
        "pick_peach": [-1.0738, 0.6108, 0.2796, -1.2836, 0.7301, 1.4947, -0.1875, 1.0743, -0.611 , -0.2796, 1.2839, -0.7304, -1.4953, 0.1876] + [1.0, 0.0] + [0.9599, 0.4363] + [0.0, 27.0] + [0.0, 0.0],
        "place_apple": None,
        "place_orange": None,
        "place_peach": None,
        "open_door": None,
