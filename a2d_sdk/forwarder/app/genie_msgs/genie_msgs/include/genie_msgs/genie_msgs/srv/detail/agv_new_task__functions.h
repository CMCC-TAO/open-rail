...
#ifndef GENIE_MSGS__SRV__DETAIL__AGV_NEW_TASK__FUNCTIONS_H_
#define GENIE_MSGS__SRV__DETAIL__AGV_NEW_TASK__FUNCTIONS_H_
...
/// Initialize srv/AGVNewTask message.
/**
...
/// Finalize srv/AGVNewTask message.
/**
...
/// Create srv/AGVNewTask message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * genie_msgs__srv__AGVNewTask_Request__init().
...
/// Destroy srv/AGVNewTask message.
/**
 * It calls
 * genie_msgs__srv__AGVNewTask_Request__fini()
...
/// Check for srv/AGVNewTask message equality.
/**
...
/// Initialize array of srv/AGVNewTask messages.
/**
...
/// Finalize array of srv/AGVNewTask messages.
/**
 * It calls
 * genie_msgs__srv__AGVNewTask_Request__fini()
...
/// Create array of srv/AGVNewTask messages.
/**
 * It allocates the memory for the array and calls
 * genie_msgs__srv__AGVNewTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AGVNewTask messages.
/**
 * It calls
 * genie_msgs__srv__AGVNewTask_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AGVNewTask message array equality.
/**
...
/// Copy an array of srv/AGVNewTask messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * genie_msgs__srv__AGVNewTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_genie_msgs
...
/**
 * It calls
 * genie_msgs__srv__AGVNewTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_genie_msgs
...
/**
 * It allocates the memory for the array and calls
 * genie_msgs__srv__AGVNewTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_genie_msgs
...
/**
 * It calls
 * genie_msgs__srv__AGVNewTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GENIE_MSGS__SRV__DETAIL__AGV_NEW_TASK__FUNCTIONS_H_
