...
genie_msgs__srv__ForceZeroCal_Request__init(genie_msgs__srv__ForceZeroCal_Request * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    genie_msgs__srv__ForceZeroCal_Request__fini(msg);
    return false;
  }
  return true;
}
...
genie_msgs__srv__ForceZeroCal_Request__create()
{
  ...
  genie_msgs__srv__ForceZeroCal_Request * msg = (genie_msgs__srv__ForceZeroCal_Request *)allocator.allocate(sizeof(genie_msgs__srv__ForceZeroCal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(genie_msgs__srv__ForceZeroCal_Request));
  bool success = genie_msgs__srv__ForceZeroCal_Request__init(msg);
  if (!success) {
...
genie_msgs__srv__ForceZeroCal_Request__Sequence__init(genie_msgs__srv__ForceZeroCal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  genie_msgs__srv__ForceZeroCal_Request * data = NULL;

  if (size) {
    data = (genie_msgs__srv__ForceZeroCal_Request *)allocator.zero_allocate(size, sizeof(genie_msgs__srv__ForceZeroCal_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = genie_msgs__srv__ForceZeroCal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        genie_msgs__srv__ForceZeroCal_Request__fini(&data[i - 1]);
      }
...
genie_msgs__srv__ForceZeroCal_Request__Sequence__fini(genie_msgs__srv__ForceZeroCal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      genie_msgs__srv__ForceZeroCal_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  genie_msgs__srv__ForceZeroCal_Request__Sequence * array = (genie_msgs__srv__ForceZeroCal_Request__Sequence *)allocator.allocate(sizeof(genie_msgs__srv__ForceZeroCal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = genie_msgs__srv__ForceZeroCal_Request__Sequence__init(array, size);
  if (!success) {
...
genie_msgs__srv__ForceZeroCal_Request__Sequence__destroy(genie_msgs__srv__ForceZeroCal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    genie_msgs__srv__ForceZeroCal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
genie_msgs__srv__ForceZeroCal_Request__Sequence__are_equal(const genie_msgs__srv__ForceZeroCal_Request__Sequence * lhs, const genie_msgs__srv__ForceZeroCal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!genie_msgs__srv__ForceZeroCal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  genie_msgs__srv__ForceZeroCal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(genie_msgs__srv__ForceZeroCal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    genie_msgs__srv__ForceZeroCal_Request * data =
      (genie_msgs__srv__ForceZeroCal_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!genie_msgs__srv__ForceZeroCal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          genie_msgs__srv__ForceZeroCal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!genie_msgs__srv__ForceZeroCal_Request__copy(
...
genie_msgs__srv__ForceZeroCal_Response__init(genie_msgs__srv__ForceZeroCal_Response * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->res_header)) {
    genie_msgs__srv__ForceZeroCal_Response__fini(msg);
    return false;
  }
  // exec_result
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  genie_msgs__srv__ForceZeroCal_Response * msg = (genie_msgs__srv__ForceZeroCal_Response *)allocator.allocate(sizeof(genie_msgs__srv__ForceZeroCal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(genie_msgs__srv__ForceZeroCal_Response));
  bool success = genie_msgs__srv__ForceZeroCal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
genie_msgs__srv__ForceZeroCal_Response__Sequence__init(genie_msgs__srv__ForceZeroCal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  genie_msgs__srv__ForceZeroCal_Response * data = NULL;

  if (size) {
    data = (genie_msgs__srv__ForceZeroCal_Response *)allocator.zero_allocate(size, sizeof(genie_msgs__srv__ForceZeroCal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = genie_msgs__srv__ForceZeroCal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        genie_msgs__srv__ForceZeroCal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
genie_msgs__srv__ForceZeroCal_Response__Sequence__fini(genie_msgs__srv__ForceZeroCal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      genie_msgs__srv__ForceZeroCal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  genie_msgs__srv__ForceZeroCal_Response__Sequence * array = (genie_msgs__srv__ForceZeroCal_Response__Sequence *)allocator.allocate(sizeof(genie_msgs__srv__ForceZeroCal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = genie_msgs__srv__ForceZeroCal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
genie_msgs__srv__ForceZeroCal_Response__Sequence__destroy(genie_msgs__srv__ForceZeroCal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    genie_msgs__srv__ForceZeroCal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
genie_msgs__srv__ForceZeroCal_Response__Sequence__are_equal(const genie_msgs__srv__ForceZeroCal_Response__Sequence * lhs, const genie_msgs__srv__ForceZeroCal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!genie_msgs__srv__ForceZeroCal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  genie_msgs__srv__ForceZeroCal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(genie_msgs__srv__ForceZeroCal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    genie_msgs__srv__ForceZeroCal_Response * data =
      (genie_msgs__srv__ForceZeroCal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!genie_msgs__srv__ForceZeroCal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          genie_msgs__srv__ForceZeroCal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!genie_msgs__srv__ForceZeroCal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
