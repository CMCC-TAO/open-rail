...
#ifndef GENIE_MSGS__MSG__DETAIL__VR_NETWORK__TRAITS_HPP_
#define GENIE_MSGS__MSG__DETAIL__VR_NETWORK__TRAITS_HPP_
...
inline std::string to_yaml(const VRNetwork & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const genie_msgs::msg::VRNetwork & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const genie_msgs::msg::VRNetwork & msg)
{
  return genie_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<genie_msgs::msg::VRNetwork>()
{
  return "genie_msgs::msg::VRNetwork";
}

template<>
inline const char * name<genie_msgs::msg::VRNetwork>()
{
  return "genie_msgs/msg/VRNetwork";
}

template<>
struct has_fixed_size<genie_msgs::msg::VRNetwork>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<genie_msgs::msg::VRNetwork>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<genie_msgs::msg::VRNetwork>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GENIE_MSGS__MSG__DETAIL__VR_NETWORK__TRAITS_HPP_
