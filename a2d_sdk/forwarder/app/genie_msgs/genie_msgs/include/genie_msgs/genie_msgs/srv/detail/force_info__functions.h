...
#ifndef GENIE_MSGS__SRV__DETAIL__FORCE_INFO__FUNCTIONS_H_
#define GENIE_MSGS__SRV__DETAIL__FORCE_INFO__FUNCTIONS_H_
...
/// Initialize srv/ForceInfo message.
/**
...
/// Finalize srv/ForceInfo message.
/**
...
/// Create srv/ForceInfo message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * genie_msgs__srv__ForceInfo_Request__init().
...
/// Destroy srv/ForceInfo message.
/**
 * It calls
 * genie_msgs__srv__ForceInfo_Request__fini()
...
/// Check for srv/ForceInfo message equality.
/**
...
/// Initialize array of srv/ForceInfo messages.
/**
...
/// Finalize array of srv/ForceInfo messages.
/**
 * It calls
 * genie_msgs__srv__ForceInfo_Request__fini()
...
/// Create array of srv/ForceInfo messages.
/**
 * It allocates the memory for the array and calls
 * genie_msgs__srv__ForceInfo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ForceInfo messages.
/**
 * It calls
 * genie_msgs__srv__ForceInfo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ForceInfo message array equality.
/**
...
/// Copy an array of srv/ForceInfo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * genie_msgs__srv__ForceInfo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_genie_msgs
...
/**
 * It calls
 * genie_msgs__srv__ForceInfo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_genie_msgs
...
/**
 * It allocates the memory for the array and calls
 * genie_msgs__srv__ForceInfo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_genie_msgs
...
/**
 * It calls
 * genie_msgs__srv__ForceInfo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GENIE_MSGS__SRV__DETAIL__FORCE_INFO__FUNCTIONS_H_
